...
const emailSender_1 = __importDefault(require("../../middlewares/emailSender"));
...
const loginUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const refresshToken = jwtHelpers_1.jwtHelpers.generateToken({
        email: userData.email,
        role: userData.role,
...
const forgotPassword = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const resetPasswordTOken = jwtHelpers_1.jwtHelpers.generateToken({
        email: payload.email,
        role: userData.role,
    }, config_1.default.jwt.reset_password_token, config_1.default.jwt.reset_password_token_expiser_in);
