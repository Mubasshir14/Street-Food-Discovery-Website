...
const initPayment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = req.user;
    if (!amount || !expiresIn) {
        throw new AppError_1.default(http_status_1.default.BAD_REQUEST, "Amount and expiresIn are required");
    }
    const result = yield payment_service_1.PaymentService.initPayment(user, amount, expiresIn);
...
const validatePayment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        res.redirect(`${config_1.default.sslCommerz.success_url}`);
    }
    // sendResponse(res, {
