...
router.post("/create-category", (0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.USER), fileUploader_1.FileUploader.upload.single("file"), (req, res, next) => {
