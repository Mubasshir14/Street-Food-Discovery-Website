...
router.post("/:id", (0, auth_1.default)(prisma_1.UserRole.USER), comment_controller_1.CommentController.createComment);
router.delete("/:id", (0, auth_1.default)(prisma_1.UserRole.ADMIN), comment_controller_1.CommentController.deleteCommentById);
